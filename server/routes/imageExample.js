...
const ProfilePicture = require("../models/ProfilePicture"); //* need to create one?
...
conn.once("open", () => {
  gfs = new mongoose.mongo.GridFSBucket(conn.db, {
    bucketName: "images", // 'profileImages'
  });
});

// create storage engine or storage objet
const storage = new GridFsStorage({
  url: mongoURI,
  options: { useUnifiedTopology: true },
  file: (req, file) => {
    return new Promise((resolve, reject) => {
      //rename the original file with crypto
