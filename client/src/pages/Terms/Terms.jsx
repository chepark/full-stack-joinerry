  ...
  return (
    <div className="container" data-section="terms">
      <div className="content-wrapper" data-section="terms">
        ...
        <div>
          Welcome to Joinerry! These terms and conditions outline the rules and
          regulations for the use of Joinerry's Website, located at joinerry.io.
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Joinerry if you do not agree to
        ...
        <div>
          ...
          cookies in agreement with the Joinerry's Privacy Policy. Most
        ...
        <div>
          ...
          intellectual property rights for all material on Joinerry. All
          ...
          website. Joinerry does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Joinerry,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Joinerry shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website. Joinerry
          ...
          <ul>
            ...
            <li>
              You hereby grant Joinerry a non-exclusive license to use,
        ...
        <div>
          ...
          sending an e-mail to Joinerry. Please include your name, your
